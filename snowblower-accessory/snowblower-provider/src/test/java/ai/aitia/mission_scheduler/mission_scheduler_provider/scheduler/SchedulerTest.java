...
// import ai.aitia.snowblower.common.Mission;
...
public class SchedulerTest {
    ...
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "first", 0));
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "second", 0));
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "third", 0));
    ...
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "low", 1));
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "high", 20));
    //     scheduler.addMission(new Mission(new ArrayList<String>(), "middle", 3));
